...
public interface BinaryTreeTAD<E> {
     ...
     * @param father Nodo ap�s o qual ser� inserido o novo nodo, se null ent�o
     * insere na raiz.
     * @param position NodePosition.LEFT para filho da esquerda ou
    ...
    /**
     * Recupera a quantidade de nodos folha da �rvore, atrav�s de c�lculo
     * recursivo.
     *
     * @return n�mero de nodos.
     */
